        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <p>Wallet Balance : $ {{ auth()->user()->balance }}</p>
...
<div style="padding-top: 10px;">
                    <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="amount" type="number" step="1" class="form-control" name="amount"  required autofocus>
                            </div>                <!--sanitised input for integer only-->
                        </div>
<div style="padding-top: 10px;">
